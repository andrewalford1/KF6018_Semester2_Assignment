 ...
 */
class FrontWall extends ENGINE.OBJECTS.ClassicObject
{
    /**
    ...
    constructor(position)
    {
        ...
        this.addObjectToGroup(new THREE.Mesh(
            new THREE.BoxGeometry(0.5, 30, 50),
        ...
        */
        ...
        //Left Boxes
            ...
            let physicsProperties = new CANNON.Body({
                mass: 0,
                shape: new CANNON.Box(new CANNON.Vec3(0.5, 30, 25))
            });
            physicsProperties.position.copy(new THREE.Vector3(-21, 16, -310));
