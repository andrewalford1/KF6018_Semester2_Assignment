    ...
    constructor(player)
        {
            ...
            //----------------------------------------------------
            let fDistanceBetweenLHAndRH = Math.sqrt((leftHandMesh.position.x - rightHandMesh.position.x)*
             ...
             //------------------------------------------------------
             let fDistanceBetweenHeadAndLH = Math.sqrt((leftHandMesh.position.x - headMesh.position.x)*
              ...
              //------------------------------------------------------
             let fDistanceBetweenHeadAndRH = Math.sqrt((rightHandMesh.position.x - headMesh.position.x)*
            ...
            */
            this.handAboveSholder = function() {
                if(leftHandMesh.position.y > leftSholderMesh.position.y ||  
            ...
            */
            this.kameHameHa = function() {
                if( (leftHandMesh.position.y < spineSholderMesh.position.y &&
